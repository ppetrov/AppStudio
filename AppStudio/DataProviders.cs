...
namespace AppStudio
{
	public static class DataProviders
	{
		...
		public static Dictionary<long, ActivationCompliance> GetActivationCompliances(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, ActivationCompliance>();
		...
		public static Dictionary<long, ActivationDefinition> GetActivationDefinitions(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, ActivationDefinition>();
		...
		public static Dictionary<long, ActivationReject> GetActivationRejects(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, ActivationReject>();
		...
		public static Dictionary<long, ActivationStatu> GetActivationStatus(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, ActivationStatu>();
		...
		public static Dictionary<long, Activitie> GetActivities(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, Activitie>();
		...
		public static Dictionary<long, ActivityStatuse> GetActivityStatuses(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, ActivityStatuse>();
		...
		public static Dictionary<long, ActivityStatusLog> GetActivityStatusLogs(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, ActivityStatusLog>();
		...
		public static Dictionary<long, ActivityType> GetActivityTypes(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, ActivityType>();
		...
		public static Dictionary<long, AllArticleGroup> GetAllArticleGroups(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, AllArticleGroup>();
		...
		public static Dictionary<long, ArticlePrice> GetArticlePrices(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, ArticlePrice>();
		...
		public static Dictionary<long, ArticleSnap> GetArticleSnaps(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, ArticleSnap>();
		...
		public static Dictionary<long, ArticleType> GetArticleTypes(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, ArticleType>();
		...
		public static Dictionary<long, ArticleUnitConversion> GetArticleUnitConversions(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, ArticleUnitConversion>();
		...
		public static Dictionary<long, ArBankDeposit> GetArBankDeposits(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, ArBankDeposit>();
		...
		public static Dictionary<long, ArCurrency> GetArCurrencys(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, ArCurrency>();
		...
		public static Dictionary<long, ArInvoice> GetArInvoices(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, ArInvoice>();
		...
		public static Dictionary<long, ArPayment> GetArPayments(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, ArPayment>();
		...
		public static Dictionary<long, ArPaymentCheque> GetArPaymentCheques(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, ArPaymentCheque>();
		...
		public static Dictionary<long, ArPaymentDetail> GetArPaymentDetails(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, ArPaymentDetail>();
		...
		public static Dictionary<long, Assortment> GetAssortments(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, Assortment>();
		...
		public static Dictionary<long, AtpOrderDetail> GetAtpOrderDetails(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, AtpOrderDetail>();
		...
		public static Dictionary<long, AtpOrderMessage> GetAtpOrderMessages(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, AtpOrderMessage>();
		...
		public static Dictionary<long, BeaconLog> GetBeaconLogs(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, BeaconLog>();
		...
		public static Dictionary<long, BusinessType> GetBusinessTypes(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, BusinessType>();
		...
		public static Dictionary<long, CallingAssignment> GetCallingAssignments(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, CallingAssignment>();
		...
		public static Dictionary<long, CallingRoute> GetCallingRoutes(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, CallingRoute>();
		...
		public static Dictionary<long, CcafChannel> GetCcafChannels(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, CcafChannel>();
		...
		public static Dictionary<long, CcafSegment> GetCcafSegments(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, CcafSegment>();
		...
		public static Dictionary<long, CcOrder> GetCcOrders(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, CcOrder>();
		...
		public static Dictionary<long, CcOrderDetail> GetCcOrderDetails(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, CcOrderDetail>();
		...
		public static Dictionary<long, ChannelAssortment> GetChannelAssortments(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, ChannelAssortment>();
		...
		public static Dictionary<long, ClientSequence> GetClientSequences(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, ClientSequence>();
		...
		public static Dictionary<long, ClientVersion> GetClientVersions(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, ClientVersion>();
		...
		public static Dictionary<long, ComplaintDetail> GetComplaintDetails(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, ComplaintDetail>();
		...
		public static Dictionary<long, ContactPerson> GetContactPersons(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, ContactPerson>();
		...
		public static Dictionary<long, ContractTemplate> GetContractTemplates(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, ContractTemplate>();
		...
		public static Dictionary<long, CusPlanningToolCust> GetCusPlanningToolCusts(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, CusPlanningToolCust>();
		...
		public static Dictionary<long, CusPopAssortment> GetCusPopAssortments(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, CusPopAssortment>();
		...
		public static Dictionary<long, CusSurvey> GetCusSurveys(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, CusSurvey>();
		...
		public static Dictionary<long, CusSurveysHierNode> GetCusSurveysHierNodes(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, CusSurveysHierNode>();
		...
		public static Dictionary<long, DeliveryHistDetail> GetDeliveryHistDetails(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, DeliveryHistDetail>();
		...
		public static Dictionary<long, DeliveryHistHeader> GetDeliveryHistHeaders(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, DeliveryHistHeader>();
		...
		public static Dictionary<long, DeliveryLeadTime> GetDeliveryLeadTimes(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, DeliveryLeadTime>();
		...
		public static Dictionary<long, DeliveryLocation> GetDeliveryLocations(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, DeliveryLocation>();
		...
		public static Dictionary<long, DeliveryTransaction> GetDeliveryTransactions(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, DeliveryTransaction>();
		...
		public static Dictionary<long, DeliveryType> GetDeliveryTypes(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, DeliveryType>();
		...
		public static Dictionary<long, Equipment> GetEquipments(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));
		...
		public static Dictionary<long, EquipmentActivity> GetEquipmentActivitys(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, EquipmentActivity>();
		...
		public static Dictionary<long, EquipmentCheck> GetEquipmentChecks(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, EquipmentCheck>();
		...
		public static Dictionary<long, EquipmentMatrix> GetEquipmentMatrixs(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, EquipmentMatrix>();
		...
		public static Dictionary<long, EquipmentMatrixType> GetEquipmentMatrixTypes(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, EquipmentMatrixType>();
		...
		public static Dictionary<long, EquipmentMessage> GetEquipmentMessages(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, EquipmentMessage>();
		...
		public static Dictionary<long, EquipmentType> GetEquipmentTypes(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, EquipmentType>();
		...
		public static Dictionary<long, EquipmentTypeImage> GetEquipmentTypeImages(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, EquipmentTypeImage>();
		...
		public static Dictionary<long, GpsData> GetGpsDatas(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, GpsData>();
		...
		public static Dictionary<long, Holiday> GetHolidays(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, Holiday>();
		...
		public static Dictionary<long, InventoryDetail> GetInventoryDetails(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, InventoryDetail>();
		...
		public static Dictionary<long, InventoryHeader> GetInventoryHeaders(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, InventoryHeader>();
		...
		public static Dictionary<long, LinkedWholesaler> GetLinkedWholesalers(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, LinkedWholesaler>();
		...
		public static Dictionary<long, MaterialCategorie> GetMaterialCategories(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, MaterialCategorie>();
		...
		public static Dictionary<long, MeasureDomain> GetMeasureDomains(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, MeasureDomain>();
		...
		public static Dictionary<long, MeasureDomainLov> GetMeasureDomainLovs(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, MeasureDomainLov>();
		...
		public static Dictionary<long, MeasureNode> GetMeasureNodes(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, MeasureNode>();
		...
		public static Dictionary<long, MeasureValue> GetMeasureValues(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, MeasureValue>();
		...
		public static Dictionary<long, OrderDateOutletCpl> GetOrderDateOutletCpls(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, OrderDateOutletCpl>();
		...
		public static Dictionary<long, OrderDetail> GetOrderDetails(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, OrderDetail>();
		...
		public static Dictionary<long, OrderDetailPromotion> GetOrderDetailPromotions(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, OrderDetailPromotion>();
		...
		public static Dictionary<long, OrderFreeProduct> GetOrderFreeProducts(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, OrderFreeProduct>();
		...
		public static Dictionary<long, OrderHeader> GetOrderHeaders(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, OrderHeader>();
		...
		public static Dictionary<long, OrderText> GetOrderTexts(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, OrderText>();
		...
		public static Dictionary<long, OrderType> GetOrderTypes(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, OrderType>();
		...
		public static Dictionary<long, OutletsExtension> GetOutletsExtensions(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, OutletsExtension>();
		...
		public static Dictionary<long, OutletsTempData> GetOutletsTempDatas(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, OutletsTempData>();
			...
			var query = new Query<OutletsTempData>(@"SELECT OUTLET_NUMBER, TYPE, WHOLESALER, RAW_DATA, CREATED_AT FROM OUTLETS_TEMP_DATA", r =>
			{
				...
				var type = Query.GetLong(r, 1);
				var wholesaler = Query.GetString(r, 2);
				var rawData = Query.GetString(r, 3);
				var createdAt = Query.GetDateTime(r, 4);
		...
		public static Dictionary<long, OutletAddresse> GetOutletAddresses(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, OutletAddresse>();
		...
		public static Dictionary<long, OutletCluster> GetOutletClusters(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, OutletCluster>();
		...
		public static Dictionary<long, OutletHierLevel> GetOutletHierLevels(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, OutletHierLevel>();
		...
		public static Dictionary<long, OutletMarketAttribute> GetOutletMarketAttributes(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, OutletMarketAttribute>();
		...
		public static Dictionary<long, OutletRule> GetOutletRules(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, OutletRule>();
		...
		public static Dictionary<long, OutletSnap> GetOutletSnaps(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, OutletSnap>();

			var businessTypes = cache.GetData<BusinessType>(dbContext);
			...
			var query = new Query<OutletSnap>(@"SELECT ADDRESS, BANK_ACCOUNT_NUMBER, BILLING_BLOCK, BILL_TO_OUTLET_NUMBER, BUSINESS_TYPE_CODE, CITY, CONTACT_PERSON, CREDIT_DAYS, CREDIT_LIMIT, CURRENCY, CUSTOMER_GROUP, DELIVERY_BLOCK, DELIVERY_DELAY, DELIVERY_LEAD_TIME_CODE, DELIVERY_LOCATION_CODE, DELIVERY_TRANSACTIONS_DESC, DELIVERY_TRANSACTION_CODE, DELIVERY_TYPE_CODE, EMAIL, EXPRESS_ORDER_ALLOWED, FACTORY, FAX, LATITUDE, LONGITUDE, NAME1, NAME2, ORDER_BLOCK, OUTLET_NUMBER, PAYER_NUMBER, POSTAL_CODE, PRICE_GROUP, PRIMARY_CONSUMER_ACTIVITY, RED_POS_ID, SALES_BLOCK, SALES_DISTRICT_CODE, SALES_GROUP_CODE, SALES_OFFICE_CODE, SHIP_TO_OUTLET_NUMBER, SUB_TRADE_CHANNEL_CODE, SUPPRESSED_CODE, SUPPRESSION_DATE, TELEPHONE, TELEPHONE_2, TRADE_CHANNEL_CODE, VAT_NUMBER, WHOLESALER_ID FROM OUTLET_SNAP", r =>
			{
				...
				var businesstype = businessTypes[Query.GetLong(r, 4)];
		...
		public static Dictionary<long, OutletText> GetOutletTexts(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, OutletText>();
		...
		public static Dictionary<long, Parameter> GetParameters(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, Parameter>();
		...
		public static Dictionary<long, PayerOutlet> GetPayerOutlets(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, PayerOutlet>();
		...
		public static Dictionary<long, Phpooledsnapcolumndesc> GetPhpooledsnapcolumndescs(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, Phpooledsnapcolumndesc>();
		...
		public static Dictionary<long, PlacementRequest> GetPlacementRequests(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, PlacementRequest>();
		...
		public static Dictionary<long, PlannedVolume> GetPlannedVolumes(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, PlannedVolume>();
		...
		public static Dictionary<long, PlanningToolDailyCustom> GetPlanningToolDailyCustoms(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, PlanningToolDailyCustom>();
		...
		public static Dictionary<long, PlanningToolDailyTarget> GetPlanningToolDailyTargets(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, PlanningToolDailyTarget>();
		...
		public static Dictionary<long, PlanningToolDailyVolume> GetPlanningToolDailyVolumes(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, PlanningToolDailyVolume>();
		...
		public static Dictionary<long, PlanningToolTarget> GetPlanningToolTargets(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, PlanningToolTarget>();
		...
		public static Dictionary<long, PlanningToolTeam> GetPlanningToolTeams(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, PlanningToolTeam>();
		...
		public static Dictionary<long, PlanningToolUser> GetPlanningToolUsers(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, PlanningToolUser>();
		...
		public static Dictionary<long, PopArticle> GetPopArticles(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, PopArticle>();
		...
		public static Dictionary<long, PopEntrie> GetPopEntries(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, PopEntrie>();
		...
		public static Dictionary<long, PromotionHeader> GetPromotionHeaders(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, PromotionHeader>();
		...
		public static Dictionary<long, PromotionPrdItem> GetPromotionPrdItems(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, PromotionPrdItem>();
		...
		public static Dictionary<long, PromoMechanicsHeader> GetPromoMechanicsHeaders(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, PromoMechanicsHeader>();
		...
		public static Dictionary<long, PromoPartnersHierarchy> GetPromoPartnersHierarchys(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, PromoPartnersHierarchy>();
		...
		public static Dictionary<long, PromoScale> GetPromoScales(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, PromoScale>();
		...
		public static Dictionary<long, RedActivitiesLog> GetRedActivitiesLogs(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, RedActivitiesLog>();
		...
		public static Dictionary<long, RedCccH> GetRedCccHs(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, RedCccH>();
		...
		public static Dictionary<long, RedCccList> GetRedCccLists(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, RedCccList>();
		...
		public static Dictionary<long, RedCccOutl> GetRedCccOutls(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, RedCccOutl>();
		...
		public static Dictionary<long, RedCccParVal> GetRedCccParVals(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, RedCccParVal>();
		...
		public static Dictionary<long, RedCccTarg> GetRedCccTargs(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, RedCccTarg>();
		...
		public static Dictionary<long, RedCccTarVal> GetRedCccTarVals(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, RedCccTarVal>();
		...
		public static Dictionary<long, RedGapsAction> GetRedGapsActions(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, RedGapsAction>();
		...
		public static Dictionary<long, RedGapsPlanning> GetRedGapsPlannings(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, RedGapsPlanning>();
		...
		public static Dictionary<long, RedListingAnswer> GetRedListingAnswers(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, RedListingAnswer>();
		...
		public static Dictionary<long, RedListingHeader> GetRedListingHeaders(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, RedListingHeader>();
		...
		public static Dictionary<long, RedListingItem> GetRedListingItems(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, RedListingItem>();
		...
		public static Dictionary<long, RedListMapping> GetRedListMappings(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, RedListMapping>();
		...
		public static Dictionary<long, RedListParam> GetRedListParams(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, RedListParam>();
		...
		public static Dictionary<long, RedMapping> GetRedMappings(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, RedMapping>();
		...
		public static Dictionary<long, RedParamsValue> GetRedParamsValues(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, RedParamsValue>();
		...
		public static Dictionary<long, RedPosDescription> GetRedPosDescriptions(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, RedPosDescription>();
		...
		public static Dictionary<long, SalesDistrict> GetSalesDistricts(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, SalesDistrict>();
		...
		public static Dictionary<long, SapActivityHistory> GetSapActivityHistorys(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, SapActivityHistory>();
		...
		public static Dictionary<long, SapActivityHistoryDetail> GetSapActivityHistoryDetails(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, SapActivityHistoryDetail>();
		...
		public static Dictionary<long, SapActivityProcType> GetSapActivityProcTypes(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, SapActivityProcType>();
		...
		public static Dictionary<long, ShipToOutlet> GetShipToOutlets(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, ShipToOutlet>();
		...
		public static Dictionary<long, SmartDeviceType> GetSmartDeviceTypes(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, SmartDeviceType>();
		...
		public static Dictionary<long, StatusList> GetStatusLists(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, StatusList>();
		...
		public static Dictionary<long, SubTradeChannel> GetSubTradeChannels(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, SubTradeChannel>();
		...
		public static Dictionary<long, Survey> GetSurveys(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, Survey>();
		...
		public static Dictionary<long, SurveyActivitie> GetSurveyActivities(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, SurveyActivitie>();
		...
		public static Dictionary<long, Tracing> GetTracings(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, Tracing>();
		...
		public static Dictionary<long, TradeChannel> GetTradeChannels(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, TradeChannel>();
		...
		public static Dictionary<long, UserMessage> GetUserMessages(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, UserMessage>();
		...
		public static Dictionary<long, UserRouteSnap> GetUserRouteSnaps(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, UserRouteSnap>();
		...
		public static Dictionary<long, UserSetting> GetUserSettings(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, UserSetting>();
		...
		public static Dictionary<long, UserSnap> GetUserSnaps(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, UserSnap>();
		...
		public static Dictionary<long, Visit> GetVisits(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, Visit>();
		...
		public static Dictionary<long, VisitComment> GetVisitComments(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, VisitComment>();
		...
		public static Dictionary<long, Wholesaler> GetWholesalers(IDbContext dbContext, DataCache cache)
		{
			if (dbContext == null) throw new ArgumentNullException(nameof(dbContext));
			if (cache == null) throw new ArgumentNullException(nameof(cache));

			var items = new Dictionary<long, Wholesaler>();

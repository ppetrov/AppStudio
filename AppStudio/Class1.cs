...
namespace AppStudio
{
	...
	public sealed class BeaconLog
	{
		...
		public BeaconLog(string guid, DateTime startedAt, DateTime finishedAt, string equipmentNumber, string eddystoneInstance, long outletNumber, long userId, string operationType, long numberOfEvents, long numberOfImages, string status, string errorText, long sizeInBytes)
		{
	...
	public sealed class OutletSnap
	{
		...
		public long BusinessTypeCode { get; }
		public string City { get; }
